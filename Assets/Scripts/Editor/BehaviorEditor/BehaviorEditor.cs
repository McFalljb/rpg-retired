...
namespace SA.BehaviorEditor
{
    public class BehaviorEditor : EditorWindow
    {
		...
		public static StatesManager currentStateManager;
		public static bool forceSetDirty;
		static StatesManager prevStateManager;
		...
		private void OnGUI()
        {
			...
			{
				currentStateManager = Selection.activeTransform.GetComponentInChildren<StatesManager>();
